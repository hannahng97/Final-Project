...
# Celtics vs Bucks Playoffs Game 6 April 26
...
## Overall NBA Game Prediction w/ historical data
...
# Kyrie Irving (out for rest of season, missd Game 6)
# Kyrie vs other key players averages
# Field Goals
